	...
	public DialChart06View(Context context, AttributeSet attrs){   
	 ...
	 @Override  
		...
		private void addAttrInfo()
		{
			...
			plotAttrInfo.addAttributeInfo(XEnum.Location.TOP, "RPM", 0.3f, paintTB);
			...
			plotAttrInfo.addAttributeInfo(XEnum.Location.BOTTOM, 
					Float.toString(MathHelper.getInstance().round(mPercentage * 100*100,2)), 0.3f, paintBT);
			...
			plotAttrInfo.addAttributeInfo(XEnum.Location.BOTTOM, "RPM", 0.4f, paintBT2);
			...
			plotAttrInfo.addAttributeInfo(XEnum.Location.LEFT, "Slow", 0.9f, paintDesc);
			plotAttrInfo.addAttributeInfo(XEnum.Location.TOP, "Fast", 0.9f, paintDesc);
			plotAttrInfo.addAttributeInfo(XEnum.Location.RIGHT, "High", 0.9f, paintDesc);
			plotAttrInfo.addAttributeInfo(XEnum.Location.BOTTOM, "Ultra", 0.9f, paintDesc);
