 ...
 *  
 */
public class DialChart09View extends GraphicalView {
	...
	public DialChart09View(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initView();
	}

	public DialChart09View(Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
	 }

	 public DialChart09View(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 @Override  
		...
		public void addAxis()
		{
			...
			chart.getPointer().getPointerPaint().setColor(Color.rgb(200, 10, 55) );
			chart.getPointer().getPointerPaint().setStrokeWidth(1);
		...
		{					
			...
			mp.get(0).getPointerPaint().setColor(Color.GREEN);
		...
		private void addAttrInfo()
		{
			...
			plotAttrInfo.addAttributeInfo(XEnum.Location.TOP, "Fuel rate", 0.3f, paintTB);
			...
			plotAttrInfo.addAttributeInfo(XEnum.Location.BOTTOM, 
					Float.toString(MathHelper.getInstance().round(mPercentage * 10,2)), 0.3f, paintBT);
			...
			plotAttrInfo.addAttributeInfo(XEnum.Location.BOTTOM, "gal/hr", 0.4f, paintBT2);
		}
